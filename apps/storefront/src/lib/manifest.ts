...
export const MANIFEST: Manifest = {
  ...
  resources: {
    ...
    rewards: [
      ...
      { id: "storefront.rewards.daily_run", description: "The Daily Run — higher/lower on real card prices; one provably-shuffled deck per UTC day, the same for everyone, fully playable logged out. Flat once-a-day Berry claim for signed-in finishers. kingdom-096.",
        host: "storefront", path: "/api/rewards/daily-run", methods: ["GET", "POST"],
        modalities: ["json"], auth: "public", provenance: "live",
        cosmology_axes: ["value", "time"], since: "2026-06-10" },
