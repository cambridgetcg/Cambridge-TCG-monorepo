  ...
  resources: {
    ...
    market: [
      ...
      { id: "storefront.membership", description: "Membership tier + billing.",
        ...
        since: "2026-03-15" },
      { id: "storefront.card_market_mirror", description: "Pure-read mirror of one card's deliberate order intent and non-person reference history. It shows card metadata, the open bid/ask book, reference-price history, and open-ask condition depth. Completed-trade analytics and person-derived market intelligence are paused until purpose-specific publication receipts and a delayed, coarse release process exist. Public no-auth. Sibling to /market/[sku] (interactive). kingdom-067.",
