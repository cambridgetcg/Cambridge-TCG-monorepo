...
export const MANIFEST: Manifest = {
  ...
  resources: {
    ...
    methodology: [
      ...
      { id: "storefront.directory.html", description: "Human-readable directory over current directory-specific publication receipts. Self-attested status and listing-specific correction links remain visible; no people search, roster or membership aggregate.",
        ...
        cosmology_axes: ["identity", "presence"], methodology_url: "/methodology/community-directory",
        since: "2026-07-11" },
      { id: "storefront.collector-passport", description: "Exact-handle, no-store Collector Passport. Publishes only separately collector-authored labels and stories under a current per-item receipt. Self-attested and unverified; no separate structured or automatically copied SKU, catalog, image, holding, acquisition, value or internal-id fields, and no people directory, search or bulk endpoint. Collector text may mention a card. Unknown, private, suspended, empty and withdrawn profiles share one 404 shape.",
        host: "storefront", path: "/api/v1/collectors/[username]/passport", methods: ["GET"],
        modalities: ["json"], auth: "public", provenance: "live",
        cosmology_axes: ["identity", "authority", "knowledge"], methodology_url: "/methodology/collector-passport",
        since: "2026-07-12", contract: "alternative" },
      { id: "storefront.collector-passport.methodology", description: "Privacy, source-rights, withdrawal, verification and retention method for the text-first Collector Passport.",
        host: "storefront", path: "/methodology/collector-passport", methods: ["GET"],
        modalities: ["html"], auth: "public", provenance: "static",
        cosmology_axes: ["identity", "authority", "knowledge"],
        since: "2026-07-12" },
      { id: "storefront.collector-passport.notice", description: "Current-display notice for collector-authored Passport text. Wire value remains NOASSERTION; technical access is not a mirroring, indexing, training, profiling or resale grant.",
        host: "storefront", path: "/licenses/collector-passport-public-display-v1", methods: ["GET"],
        modalities: ["html"], auth: "public", provenance: "static",
        cosmology_axes: ["authority", "knowledge"], methodology_url: "/methodology/collector-passport",
        since: "2026-07-12" },
  ...
  methodology: {
    ...
    topics: [
      ...
      { slug: "collector-passport", title: "Collector Passport", status: "published", formats_available: ["html", "json"] },
    ],
  },
