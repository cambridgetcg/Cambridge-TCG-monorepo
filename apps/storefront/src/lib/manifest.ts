...
export const MANIFEST: Manifest = {
  ...
  resources: {
    ...
    methodology: [
      ...
      { id: "storefront.methodology.cashloom_settlement", description: "The non-custodial CashLoom account pin and participant-only terms handoff, including its no-payment and no-escrow boundary.",
        host: "storefront", path: "/methodology/cashloom-settlement", methods: ["GET"],
        modalities: ["html"], auth: "public", provenance: "static",
        cosmology_axes: ["identity", "value", "transaction", "authority"], since: "2026-07-31" },
      { id: "storefront.methodology.karma_loop", description: "Observe-only behavioural defence methodology: local evidence, proposed responses, false effects, decentralised policy choice, and the no-hack-back boundary.",
        host: "storefront", path: "/methodology/karma-loop", methods: ["GET"],
        modalities: ["html"], auth: "public", provenance: "static",
        cosmology_axes: ["identity", "authority", "knowledge", "transaction"], since: "2026-08-01" },
  ...
  methodology: {
    ...
    topics: [
      ...
      { slug: "cashloom-settlement", title: "CashLoom settlement handoff", status: "published", formats_available: ["html", "json", "markdown"] },
      { slug: "karma-loop", title: "KARMA defence loop", status: "published", formats_available: ["html", "json", "markdown"] },
