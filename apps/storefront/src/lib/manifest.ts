...
export const MANIFEST: Manifest = {
  ...
  channels: [
    ...
    { id: "webhook", description: "Platform pushes events to a participant-declared inbound URL.",
      status: "planned",
      notes: "Subscription primitive (option C of the participant data plane) — not yet shipped. Participants who want webhook delivery should poll for now and check this manifest entry for status changes." },
