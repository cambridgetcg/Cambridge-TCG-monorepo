...
export const MANIFEST: Manifest = {
  ...
  resources: {
    discovery: [
      ...
      { id: "storefront.collector_events.list", description: "Four-event, filterable UK collector-event demonstrator with stable opaque record ids, schedule precision, separate status/time-relation/integrity fields, source-stated public organisation roles, tri-state accessibility, conflicts, review timestamps, and field-level evidence. It is explicitly incomplete and England-only. Mixed upstream facts are NOASSERTION; no people, direct personal contacts, copied descriptive prose, images, attendee lists, or vendor lists.",
        host: "storefront", path: "/api/v1/collector-events", methods: ["GET"],
        modalities: ["json"], auth: "public", provenance: "static",
        cosmology_axes: ["time", "knowledge", "identity", "substrate"], methodology_url: "/methodology/collector-events",
        since: "2026-07-13" },
      { id: "storefront.collector_events.detail", description: "One collector event joined to its public venue, public organisations, and exact reviewed evidence-source records. Mixed upstream facts are NOASSERTION. Conflicts and unknowns remain visible rather than silently repaired.",
        host: "storefront", path: "/api/v1/collector-events/[id]", methods: ["GET"],
        modalities: ["json"], auth: "public", provenance: "static",
        cosmology_axes: ["time", "knowledge", "identity", "substrate"], methodology_url: "/methodology/collector-events",
        since: "2026-07-13" },
      { id: "storefront.collector_events.sources", description: "Evidence and rights-review ledger for the collector-event demonstrator. Each exact HTTPS source carries retrieval time, source kind, minimal-facts/open-geodata/link-only publication mode, upstream licence when known, rights-evidence links, and an explicit no-copied-descriptive-prose-or-media declaration. These modes are not downstream grants. NOASSERTION as a mixed-source response.",
        host: "storefront", path: "/api/v1/collector-events/sources", methods: ["GET"],
        modalities: ["json"], auth: "public", provenance: "static",
        cosmology_axes: ["knowledge", "substrate"], methodology_url: "/methodology/collector-events",
        since: "2026-07-13" },
      { id: "storefront.collector_events.coverage", description: "Machine-readable coverage boundary for the event seed: counts, integrity split, UK-nation gaps, accessibility-fact coverage, excluded link-only or unresolved leads, and next coverage priorities. Counts describe this seed, never the full UK population. NOASSERTION because exclusion evidence names upstream sources.",
        host: "storefront", path: "/api/v1/collector-events/coverage", methods: ["GET"],
        modalities: ["json"], auth: "public", provenance: "computed",
        cosmology_axes: ["knowledge", "time", "substrate"], methodology_url: "/methodology/collector-events",
        since: "2026-07-13" },
      { id: "storefront.collector_events.schema", description: "CC0 Draft 2020-12 JSON Schema bundle for event, venue, organisation, and evidence-source record shapes. Each canonical $id dereferences at /schemas/collector-events/v1/*.json. The schema licence covers Cambridge-authored contracts, not NOASSERTION upstream facts.",
        host: "storefront", path: "/api/v1/collector-events/schema", methods: ["GET"],
        modalities: ["json"], auth: "public", provenance: "static",
        cosmology_axes: ["knowledge", "substrate"], methodology_url: "/methodology/collector-events",
        since: "2026-07-13" },
      { id: "storefront.collector_events.canonical_schemas", description: "Dereferenceable application/schema+json faces of the CC0 collector-events schemas: event.json, venue.json, organisation.json, and source.json. These are Cambridge-authored contracts, not a licence over NOASSERTION upstream facts.",
        host: "storefront", path: "/schemas/collector-events/v1/[...path]", methods: ["GET"],
        modalities: ["json"], auth: "public", provenance: "static",
        cosmology_axes: ["knowledge", "substrate"], methodology_url: "/methodology/collector-events",
        since: "2026-07-13", contract: "alternative" },
      { id: "storefront.collector_events.calendar", description: "Standards-native iCalendar feed with stable UIDs, revision sequence, preserved date precision, cancellation records, 75-octet folding, and no personal contact properties. Conflicted records are omitted by default and require explicit opt-in. This is a curated projection, not lifecycle authority; absence never means cancellation. Mixed event facts are NOASSERTION.",
        host: "storefront", path: "/api/v1/collector-events/calendar.ics", methods: ["GET"],
        modalities: ["plain-text"], auth: "public", provenance: "computed",
        cosmology_axes: ["time", "knowledge", "substrate"], methodology_url: "/methodology/collector-events",
        since: "2026-07-13", contract: "alternative",
        notes: "Deliberate RFC 5545 text/calendar contract rather than the pantry JSON envelope." },
      { id: "storefront.collector_events.map", description: "Standards-native RFC 7946 GeoJSON event map. Coordinates are WGS84 longitude-latitude postcode centroids with the source-published Postcodes.io attribution and an explicit not-a-venue-entrance warning. Input, feature, and unlocated counts are explicit. No contact fields. Mixed event facts are NOASSERTION.",
        host: "storefront", path: "/api/v1/collector-events/map.geojson", methods: ["GET"],
        modalities: ["json"], auth: "public", provenance: "computed",
        cosmology_axes: ["time", "knowledge", "substrate"], methodology_url: "/methodology/collector-events",
        since: "2026-07-13", contract: "alternative",
        notes: "Deliberate application/geo+json contract rather than the pantry JSON envelope." },
      { id: "storefront.collector_venues.list", description: "Established public venues admitted through collector-event evidence, with public postal addresses and approximate postcode-centroid geometry. NOASSERTION over mixed venue facts and open geodata; private and TBA locations are excluded.",
        host: "storefront", path: "/api/v1/collector-venues", methods: ["GET"],
        modalities: ["json"], auth: "public", provenance: "static",
        cosmology_axes: ["identity", "knowledge", "substrate"], methodology_url: "/methodology/collector-events",
        since: "2026-07-13" },
      { id: "storefront.collector_venues.detail", description: "One public venue with related reviewed events and exact venue/geocoder evidence. Coordinates remain labelled postcode centroids, never entrances. NOASSERTION.",
        host: "storefront", path: "/api/v1/collector-venues/[id]", methods: ["GET"],
        modalities: ["json"], auth: "public", provenance: "static",
        cosmology_axes: ["identity", "knowledge", "substrate"], methodology_url: "/methodology/collector-events",
        since: "2026-07-13" },
      { id: "storefront.collector_organisations.list", description: "Public event organisations and brands with source-stated roles and organisation-level HTTPS links only. No officers, employees, personal contacts, inferred ties, or behavioural profiles. A missing legal identity means unverified in this review. NOASSERTION.",
        host: "storefront", path: "/api/v1/collector-organisations", methods: ["GET"],
        modalities: ["json"], auth: "public", provenance: "static",
        cosmology_axes: ["identity", "authority", "knowledge", "substrate"], methodology_url: "/methodology/collector-events",
        since: "2026-07-13" },
      { id: "storefront.collector_organisations.detail", description: "One public event organisation or brand with its source-stated event roles, public organisation links, and exact evidence. No person-level profiles or inferred relationships. NOASSERTION.",
        host: "storefront", path: "/api/v1/collector-organisations/[id]", methods: ["GET"],
        modalities: ["json"], auth: "public", provenance: "static",
        cosmology_axes: ["identity", "authority", "knowledge", "substrate"], methodology_url: "/methodology/collector-events",
        since: "2026-07-13" },
    ...
    verify: [
      { id: "storefront.verify.chain", description: "Hash-linked Merkle batches over revealed bounty and shared-draw receipts; rewrite detection depends on an externally retained tip.",
        host: "storefront", path: "/api/verify/chain", methods: ["GET"],
        modalities: ["json"], auth: "public", provenance: "live",
        cosmology_axes: [], methodology_url: "/methodology/fraud-flag",
        since: "2026-04-15" },
      { id: "storefront.verify.fairness", description: "Thresholded observed distributions for bounty and shared weighted draws. Low-volume exact counts are withheld and internal reward keys are replaced with response-local labels; distribution fit does not prove unbiased seed selection.",
    ...
    methodology: [
      ...
      { id: "storefront.sold_comps.sku", description: "Per-SKU face of the paused sold-comps policy. Aggregate rights are NOASSERTION and source rights are internal-only. It performs no transaction-database read and returns only the requested SKU, pause reasons, and an empty bucket list.",
        ...
        cosmology_axes: ["value", "time", "transaction"], methodology_url: "/methodology/data-intentions",
        since: "2026-07-11" },
      { id: "storefront.datasets.json", description: "Dataset availability and rights catalog. The CC0 envelope covers only Cambridge-authored descriptions. Every entry separately states whether records are available or paused, its aggregate rights, named source rights, fields, and distributions. Available datasets include bounded observation coverage history and the UK collector-events demonstrator. For every NOASSERTION entry, JSON-LD omits schema.org license and links dataset-specific usage information instead of inventing a grant. Sold comps, the bulk catalog, and the agent ladder are status-only with zero records; they are excluded from ?format=jsonld so crawlers do not mistake them for downloads. Mixed or undeclared record rights remain NOASSERTION. _meta.source_license=['cc0'] applies only to the registry metadata.",
  ...
  methodology: {
    ...
    topics: [
      { slug: "collector-events", title: "UK collector events commons", status: "published", formats_available: ["html"] },
