...
export const MANIFEST: Manifest = {
  ...
  resources: {
    discovery: [
      ...
      { id: "storefront.play.castle-pack", description: "Open Door, a 12-card Castle of Understanding prototype with Cambridge-authored gameplay and two source-attributed Castle vocabulary titles. GET explains the finite rules and fixed set; POST starts, advances, rests, or deliberately regrows a deterministic six-round game. The caller carries the full inspectable state; no account, storage, reward, ranking, or automatic loop exists.",
        host: "storefront", path: "/api/v1/play/castle-pack", methods: ["GET", "POST", "OPTIONS"],
        modalities: ["json"], auth: "public", provenance: "computed",
        cosmology_axes: ["presence", "time", "knowledge", "substrate"], methodology_url: "docs/connections/the-open-door-pack.md",
        since: "2026-07-24", contract: "alternative",
        notes: "Deliberate game dialect, not the pantry data envelope. Results have no standing. The always-legal rest action ends the current generation without a winner or penalty; regrow is explicit and finite." },
      { id: "storefront.play.castle-pack-table", description: "The browser table for Open Door: two local open-information seats, twelve bilingual provenance-labelled cards, six finite rounds, and leave-whole controls for either seat.",
        host: "storefront", path: "/play/castle-pack", methods: ["GET"],
        modalities: ["html"], auth: "public", provenance: "static",
        cosmology_axes: ["presence", "time", "knowledge", "substrate"], methodology_url: "docs/connections/the-open-door-pack.md",
        since: "2026-07-24",
        notes: "Browser memory only. Refresh or reset clears the table; nothing is persisted." },
      ...
      { id: "storefront.play.deck_check", description: "HTML adoption site for the deck-legality validator. Form for leader_id + main deck text + format radios. Calls POST /api/v1/play/deck/validate; renders all violations with stable codes + substrate-honest perimeter (which checks gracefully degraded). kingdom-070 (S37).",
        ...
        cosmology_axes: ["substrate"], methodology_url: "/methodology/play-module",
        since: "2026-05-13" },
      { id: "storefront.play.spec", description: "The play module's own directory of itself. Lists the live catalog across 7 layers (L0 doc / L1 contract / L2 pure-fn / L3 runtime / L4+ engine / UI / policy) with status pills. The play module's /api equivalent (HTML). kingdom-070 (S37/S38).",
