...
export type PrintedKeyword = "rush" | "blocker" | "double_attack" | "banish";
...
export interface PrintedCardStats {
  ...
  life?: number;
  /** UNCONDITIONALLY possessed bracket keywords only. Conditional grants
   *  ("[DON!! x2] This Character gains [Rush]") are effects — Phase 4 —
   *  and are deliberately NOT encoded here; the card text says why.
   *  Researched + adversarially verified per card (2026-07-17). */
  keywords?: PrintedKeyword[];
  /** Card has a printed [Trigger] section (used for honest reveal labels;
   *  the trigger EFFECT is not interpreted until Phase 4). */
  hasTrigger?: boolean;
}
...
export const CARD_STATS: Record<string, PrintedCardStats> = {
  ...
  "OP01-073": { name: "Donquixote Doflamingo", category: "character", cost: 3, power: 4000, counter: 1000, color: "blue", keywords: ["blocker"] },
  "OP01-086": { name: "Overheat", category: "event", cost: 2, power: null, counter: null, color: "blue", hasTrigger: true },
  ...
  "OP02-018": { name: "Marco", category: "character", cost: 4, power: 5000, counter: 1000, color: "red", keywords: ["blocker"] },
  "OP02-019": { name: "Rakuyo", category: "character", cost: 3, power: 4000, counter: 1000, color: "red" },
  "OP02-023": { name: "You May Be a Fool...but I Still Love You", category: "event", cost: 1, power: null, counter: null, color: "red", hasTrigger: true },
  ...
  "OP02-108": { name: "Donquixote Rosinante", category: "character", cost: 2, power: 2000, counter: 1000, color: "black", keywords: ["blocker"] },
  "OP02-109": { name: "Jaguar.D.Saul", category: "character", cost: 4, power: 6000, counter: 1000, color: "black" },
  "OP02-113": { name: "Helmeppo", category: "character", cost: 3, power: 3000, counter: 1000, color: "black", hasTrigger: true },
  "OP02-116": { name: "Yamakaji", category: "character", cost: 3, power: 5000, counter: 1000, color: "black" },
  "OP02-117": { name: "Ice Age", category: "event", cost: 1, power: null, counter: null, color: "black", hasTrigger: true },
  ...
  "OP03-010": { name: "Fossa", category: "character", cost: 2, power: 2000, counter: 1000, color: "red", keywords: ["blocker"] },
  ...
  "OP03-107": { name: "Charlotte Galette", category: "character", cost: 2, power: 2000, counter: 1000, color: "yellow", keywords: ["blocker"] },
  "OP03-110": { name: "Charlotte Smoothie", category: "character", cost: 4, power: 5000, counter: 1000, color: "yellow", hasTrigger: true },
  ...
  "OP03-118": { name: "Ikoku Sovereignty", category: "event", cost: 2, power: null, counter: null, color: "yellow", hasTrigger: true },
  "OP03-121": { name: "Thunder Bolt", category: "event", cost: 2, power: null, counter: null, color: "yellow", hasTrigger: true },
  ...
  "OP05-066": { name: "Jinbe", category: "character", cost: 5, power: 6000, counter: 1000, color: "purple", keywords: ["blocker"] },
  ...
  "OP05-076": { name: "When You're at Sea You Fight against Pirates!!", category: "event", cost: 1, power: null, counter: null, color: "purple", hasTrigger: true },
  ...
  "P-057": { name: "Fleeting Lullaby", category: "event", cost: 3, power: null, counter: null, color: "green", hasTrigger: true },
  "P-058": { name: "Where the Wind Blows", category: "event", cost: 2, power: null, counter: null, color: "green", hasTrigger: true },
  ...
  "ST01-002": { name: "Usopp", category: "character", cost: 2, power: 2000, counter: 1000, color: "red", hasTrigger: true },
  ...
  "ST01-006": { name: "Tony Tony.Chopper", category: "character", cost: 1, power: 1000, counter: null, color: "red", keywords: ["blocker"] },
  ...
  "ST01-012": { name: "Monkey.D.Luffy", category: "character", cost: 5, power: 6000, counter: null, color: "red", keywords: ["rush"] },
  "ST01-013": { name: "Roronoa Zoro", category: "character", cost: 3, power: 5000, counter: null, color: "red" },
  "ST01-014": { name: "Guard Point", category: "event", cost: 1, power: null, counter: null, color: "red", hasTrigger: true },
  "ST01-015": { name: "Gum-Gum Jet Pistol", category: "event", cost: 4, power: null, counter: null, color: "red", hasTrigger: true },
  "ST01-016": { name: "Diable Jambe", category: "event", cost: 1, power: null, counter: null, color: "red", hasTrigger: true },
  ...
  "ST03-008": { name: "Trafalgar Law", category: "character", cost: 1, power: 1000, counter: null, color: "blue", keywords: ["blocker"] },
  ...
  "ST11-005": { name: "I'm invincible", category: "event", cost: 3, power: null, counter: null, color: "green", hasTrigger: true },
  ...
  "ST15-003": { name: "Kingdew", category: "character", cost: 3, power: 4000, counter: 1000, color: "red", keywords: ["blocker"] },
  ...
  "ST16-001": { name: "Uta", category: "character", cost: 4, power: 6000, counter: null, color: "green", keywords: ["blocker"] },
  "ST16-002": { name: "Gordon", category: "character", cost: 2, power: 0, counter: 1000, color: "green", keywords: ["blocker"] },
  ...
  "ST17-004": { name: "Boa Hancock", category: "character", cost: 4, power: 6000, counter: null, color: "blue", keywords: ["blocker"] },
  ...
  "ST18-002": { name: "O-Nami", category: "character", cost: 4, power: 2000, counter: 1000, color: "purple", keywords: ["blocker"] },
  ...
  "ST19-005": { name: "Monkey.D.Garp", category: "character", cost: 3, power: 4000, counter: 1000, color: "black", keywords: ["blocker"] },
  "ST20-001": { name: "Charlotte Katakuri", category: "character", cost: 5, power: 6000, counter: 1000, color: "yellow", keywords: ["blocker"] },
  "ST20-002": { name: "Charlotte Cracker", category: "character", cost: 4, power: 5000, counter: 1000, color: "yellow", hasTrigger: true },
  "ST20-003": { name: "Charlotte Brulee", category: "character", cost: 3, power: 3000, counter: 2000, color: "yellow", hasTrigger: true },
  "ST20-004": { name: "Charlotte Pudding", category: "character", cost: 3, power: 2000, counter: 1000, color: "yellow", hasTrigger: true },
