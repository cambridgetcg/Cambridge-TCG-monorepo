 ...
 * apps/admin/src/lib/queries.ts under the @/lib/admin/ namespace.
 * Imports updated to use @/lib/admin/db (the ported sfQuery/wsQuery).
 */

import type { sfQuery, wsQuery } from "@/lib/admin/db";
