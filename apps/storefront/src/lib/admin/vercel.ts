 ...
 *
 * Storefront-merge note (2026-05-14): ported from
 * apps/admin/src/lib/vercel.ts under the @/lib/admin/ namespace. PROJECTS
 * registry unchanged — still names all three (admin, storefront, wholesale)
 * because /admin/system/deploys still operates the wholesale + (legacy)
 * admin Vercel projects until Phase 8 of the merge retires the admin
 * project entirely.
 */
