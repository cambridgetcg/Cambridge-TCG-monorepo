...
export function Pagination({ page, totalPages, totalRows, pageSize, href }: PaginationProps) {
  ...
  const active = "bg-surface-subtle text-ink border border-border-strong";
  const inactive = "bg-surface text-ink-muted border border-border-subtle hover:border-border-strong hover:text-ink";
  const disabled = "px-3 py-1.5 border border-border-subtle/50 text-ink-faint rounded-md text-sm cursor-not-allowed";
