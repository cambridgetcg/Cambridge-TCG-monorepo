  ...
  return (
    <span className="relative inline-block">
      <button
        ...
        className="cursor-help border-b border-dotted border-neutral-500 text-inherit hover:border-accent-strong hover:text-accent-strong focus:outline-none focus-visible:ring-1 focus-visible:ring-accent"
      >
        {children}
      </button>
      {open && (
        <span
          id={id}
          role="tooltip"
          className="absolute left-1/2 top-full z-30 mt-1.5 w-64 -translate-x-1/2 rounded-lg border border-border-strong bg-surface px-3 py-2 text-left text-xs font-normal normal-case leading-relaxed text-ink shadow-xl"
        >
          {def}
        </span>
      )}
