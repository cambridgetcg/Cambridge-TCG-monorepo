...
export default function AuctionImageGallery({ images }: AuctionImageGalleryProps) {
  ...
  if (sorted.length === 0) {
    return (
      <div className="aspect-square bg-surface-elevated rounded-xl flex items-center justify-center text-neutral-600">
  ...
  return (
    <div className="space-y-3">
      {/* Main image */}
      <div className="aspect-square bg-surface-elevated rounded-xl overflow-hidden">
        <img
