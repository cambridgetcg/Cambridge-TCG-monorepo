      ...
      {sorted.map((bid) => (
        <div key={bid.id} className="flex items-center justify-between py-3 px-1">
          <div className="flex items-center gap-3 min-w-0">
            <div className="w-8 h-8 rounded-full bg-surface-subtle flex items-center justify-center text-ink-faint text-xs font-bold shrink-0">
            ...
            <div className="min-w-0">
              <p className="text-sm text-ink truncate">
                ...
                {bid.is_best_offer && (
                  <span className="ml-2 text-xs text-accent">(offer)</span>
                )}
              </p>
