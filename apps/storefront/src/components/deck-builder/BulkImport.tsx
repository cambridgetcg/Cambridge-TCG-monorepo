...
export default function BulkImport({ onClose, onImport }: BulkImportProps) {
  ...
  return (
    <Modal
      ...
      maxWidth="max-w-2xl"
      dismissOnOverlay={text.trim() === ""}
    >
      <div className="flex items-baseline justify-between mb-4">
        <div>
          <h2 id="bulk-import-title" className="text-xl font-bold">Import decklist</h2>
      ...
      <textarea
        ...
        rows={10}
        aria-label="Decklist"
        className="w-full bg-neutral-950 border border-neutral-800 rounded-lg px-3 py-2 text-base sm:text-sm font-mono focus:outline-none focus:border-amber-500 resize-y"
      />
