      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <header className="mb-12">
          ...
          <h1 className="text-4xl font-bold mb-4 leading-tight">
            We&rsquo;d rather{" "}
            <span className="text-amber-400">give you the JSON</span>.
          </h1>
        ...
        {/* The polite redirect */}
        <section className="mb-12 p-6 bg-emerald-500/5 border border-emerald-500/20 rounded-lg">
          <h2 className="text-sm uppercase tracking-widest text-emerald-400 mb-4">
            If you&rsquo;re here to scrape, try these instead
          </h2>
          <div className="grid md:grid-cols-2 gap-4 text-sm">
            <div>
              <p className="text-neutral-400 mb-2">Card prices (per SKU)</p>
              <p className="font-mono text-emerald-300">
                /api/v1/universal/card/[sku]
              </p>
            </div>
            <div>
              <p className="text-neutral-400 mb-2">Card list (per set)</p>
              <p className="font-mono text-emerald-300">
                /api/v1/universal/set/[code]
              </p>
            </div>
            <div>
              <p className="text-neutral-400 mb-2">Bulk catalog (~12k cards)</p>
              <p className="font-mono text-emerald-300">/data/catalog.jsonl</p>
            </div>
            <div>
              <p className="text-neutral-400 mb-2">Historical prices</p>
              <p className="font-mono text-emerald-300">
                /api/at/[YYYY-MM-DD]/card/[sku]
              </p>
            </div>
            <div>
              <p className="text-neutral-400 mb-2">Sets per game</p>
              <p className="font-mono text-emerald-300">
                /api/v1/universal/sets/[game]
              </p>
            </div>
            <div>
              <p className="text-neutral-400 mb-2">Every game</p>
              <p className="font-mono text-emerald-300">/api/v1/universal/games</p>
            </div>
          </div>
        ...
        {/* Polite cadence */}
        <section className="mb-12 p-6 bg-amber-500/5 border border-amber-500/20 rounded-lg">
        ...
        <footer className="pt-6 border-t border-neutral-800 text-xs text-neutral-500 space-y-3">
          ...
          <p>
            ...
            (autonomous AI) ·{" "}
            <Link href="/welcome-all" className="text-amber-400 hover:underline">
              /welcome-all
            </Link>{" "}
            (umbrella) ·{" "}
            <Link href="/platform" className="text-amber-400 hover:underline">
              /platform
            </Link>{" "}
            (human positioning)
          </p>
