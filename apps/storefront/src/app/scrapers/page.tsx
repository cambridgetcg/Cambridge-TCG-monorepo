      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <header className="mb-12">
          ...
          <h1 className="text-4xl font-bold mb-4 leading-tight">
            We&rsquo;d rather{" "}
            <span className="text-accent-strong">give you the JSON</span>.
          </h1>
        ...
        <section className="mb-12 p-6 bg-emerald-500/5 border border-emerald-500/20 rounded-lg">
          <h2 className="text-sm uppercase tracking-widest text-secondary mb-4">
        ...
        <footer className="pt-6 border-t border-border-subtle text-xs text-ink-faint space-y-3">
          ...
          <p>
            Other doors:{" "}
            <Link href="/agents" className="text-accent-strong hover:underline">
              /agents
            </Link>{" "}
            (autonomous AI) ·{" "}
            <Link href="/welcome-all" className="text-accent-strong hover:underline">
              /welcome-all
            </Link>{" "}
            (umbrella) ·{" "}
            <Link href="/platform" className="text-accent-strong hover:underline">
              /platform
            </Link>{" "}
            (human positioning)
          </p>
