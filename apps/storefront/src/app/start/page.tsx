    ...
    <main className="min-h-screen bg-page text-ink">
      <section className="max-w-2xl mx-auto px-4 py-16">
        ...
        <ul className="space-y-3">
          {THINGS_YOU_CAN_DO.map((d) => (
            <li key={d.href}>
              <Link
                href={d.href}
                className="block bg-surface rounded-xl p-4 hover:bg-surface-elevated transition"
              >
        ...
        <p className="text-sm text-ink-faint mt-4">
          ...
          <Link href="/welcome" className="text-accent-strong underline">
        ...
        <div className="space-y-3 text-ink-muted leading-relaxed">
          <p>
            <strong className="text-secondary">
              Trading with other people: 0% commission (<Link href="/methodology/fees" className="text-accent-strong underline">how fees work</Link>).
            </strong>{" "}
        ...
        <p className="text-ink-muted leading-relaxed">
          ...
          <Link href="/manifest" className="text-accent-strong underline">
            /manifest
          </Link>
        ...
        <div className="mt-12 flex flex-wrap gap-3">
          ...
          <Link
            href="/play"
            className="px-6 py-3 bg-surface-elevated text-ink font-bold rounded-lg hover:bg-neutral-700 transition"
          >
            Try playing
          </Link>
          <Link
            href="/about"
            className="px-6 py-3 text-ink-muted font-bold rounded-lg hover:text-ink transition"
          >
            About us
          </Link>
        </div>
