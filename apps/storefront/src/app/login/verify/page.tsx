    ...
    return (
      <main className="min-h-screen bg-page flex items-center justify-center">
        <div className="max-w-sm px-4 text-center">
          <h1 className="text-2xl font-bold text-ink mb-3">This link looks incomplete</h1>
          <p className="text-ink-muted mb-6">
            Request a fresh sign-in link and we&apos;ll get you in.
          </p>
          <Link
            href="/login"
            className="inline-block px-8 py-3 bg-accent text-black font-bold rounded-lg hover:bg-accent-strong transition"
          >
            Back to sign in
          </Link>
        </div>
