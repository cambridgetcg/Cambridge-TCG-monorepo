...
const STATUS_TONE: Record<DataPath["status"], string> = {
  ...
  experimental: "text-accent-strong",
    ...
    <div className="min-h-screen bg-page">
      <div className="max-w-4xl mx-auto px-4 py-8">
        <header className="mb-10">
          <h1 className="text-3xl font-black text-ink">Public data</h1>
          ...
          <p className="mt-3 text-xs text-ink-faint max-w-prose">
            ...
            <code className="text-accent-strong">docs/connections/the-participation-layer.md</code>.
            Sister: the machine-readable manifest at{" "}
            <Link href="/.well-known/cambridge-tcg.json" className="text-accent-strong underline">
        ...
        <div className="mb-8 grid grid-cols-3 gap-2 text-[11px] text-ink-faint">
          <div>
            <span className="text-secondary">●</span> stable — production
          </div>
          <div>
            <span className="text-accent-strong">●</span> experimental — may change
          </div>
          <div>
        ...
        <div className="space-y-10">
          {PATHS.map((group) => (
            <section key={group.group}>
              <h2 className="text-lg font-bold text-ink mb-1">{group.group}</h2>
                ...
                {group.rows.map((row) => (
                  ...
                  >
                    <div className="flex items-baseline justify-between gap-3 flex-wrap mb-1">
                      <code className="text-sm text-accent-strong font-mono break-all">
                        {row.path}
                      </code>
