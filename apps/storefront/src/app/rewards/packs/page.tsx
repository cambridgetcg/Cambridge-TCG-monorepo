...
function rarityBadgeClass(r: string): string {
  ...
  if (u === "SR") return "bg-accent/90 text-black font-bold";
  if (u === "R") return "bg-purple-500/80 text-ink font-bold";
  if (u === "UC") return "bg-blue-500/60 text-ink font-semibold";
  return "bg-neutral-600/60 text-ink-muted font-medium";
}
    ...
    <div className={`min-h-screen bg-page text-ink ${shaking ? "screen-shake" : ""}`}>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10">
        ...
        <div className="mb-8">
          ...
          {points !== null && (
            <div className="mt-4 inline-flex items-center gap-2 bg-accent/10 border border-accent/30 rounded-xl px-5 py-3">
        ...
        {phase === "select" && (
          <>
            {!loggedIn && (
              <div className="rounded-xl border border-border-strong bg-surface p-6 text-center mb-8">
                ...
                {packs.map((pack) => {
                  ...
                  return (
                    <button
                      ...
                      disabled={!loggedIn}
                      className="group rounded-xl border border-border-subtle bg-surface/50 overflow-hidden hover:border-accent/50 transition-all text-left disabled:opacity-60 disabled:cursor-not-allowed"
                    >
                      <div className="aspect-[3/4] bg-surface-elevated relative overflow-hidden">
                        ...
                        <div className="absolute top-3 right-3 bg-accent/90 text-black text-xs font-bold px-2.5 py-1 rounded-md">
                          {pack.cost_points.toLocaleString()} Berries
                        </div>
                        {pack.set_code && (
                          <div className="absolute top-3 left-3 bg-surface/80 text-ink-muted text-xs font-mono px-2 py-1 rounded-md">
                            {pack.set_code}
                          </div>
                        )}
                      </div>
                      <div className="p-5">
                        <h3 className="text-lg font-bold mb-1 group-hover:text-accent-strong transition-colors">
                          {pack.title}
                        </h3>
                        {pack.description && (
                        ...
                        {loggedIn && !canAfford && (
                          <div className="mt-3 text-xs text-red-400 bg-danger/10 border border-danger/20 rounded-lg px-3 py-1.5 text-center">
                            Not enough Berries
                          </div>
                        )}
                      </div>
          ...
          <div className="flex flex-col items-center">
            ...
            {phase === "confirm" && (
              <div className="w-full max-w-md text-center">
                <div className="aspect-[3/4] max-w-xs mx-auto rounded-xl overflow-hidden bg-surface-elevated mb-6">
                ...
                {error && (
                  <div className="mb-4 rounded-lg p-3 text-sm bg-danger/10 border border-danger/30 text-red-400">
                    {error}
                  </div>
                )}
                ...
                <div className="flex gap-3 justify-center">
                  <button
                    ...
                    className="px-6 py-3 bg-surface-elevated hover:bg-neutral-700 text-ink font-bold rounded-xl transition"
                  >
                    Back
                  </button>
                  <button
                    ...
                    className="px-8 py-3 bg-accent hover:bg-accent-strong disabled:bg-neutral-700 disabled:text-ink-faint text-black font-bold rounded-xl transition text-lg"
                  >
            ...
            {phase === "waiting" && (
              <div className="flex flex-col items-center py-20">
                <div className="w-12 h-12 border-3 border-accent-strong border-t-transparent rounded-full animate-spin mb-4" />
                <p className="text-accent-strong text-lg font-bold animate-pulse">
                  Opening...
                </p>
              </div>
            )}
            ...
            {(phase === "glow" || phase === "prompt" || phase === "tear") && (
              ...
              >
                <div
                  className={`
                    aspect-[3/4] w-64 sm:w-72 md:w-80 rounded-xl overflow-hidden bg-surface-elevated
                ...
                {phase === "prompt" && (
                  <div className="absolute inset-0 flex items-center justify-center">
                    <span className="prompt-pulse text-2xl sm:text-3xl font-black text-ink drop-shadow-[0_0_20px_rgba(251,191,36,0.8)] select-none">
                      Click to open!
                    </span>
                  </div>
                )}
              ...
              <div className="w-full">
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            {/* BACK */}
                            <div className="card-back bg-gradient-to-br from-neutral-800 via-neutral-900 to-neutral-950 border-2 border-border-strong flex items-center justify-center">
                              <div className="text-center">
                                <div className="text-3xl sm:text-4xl font-black text-accent/40 tracking-tighter">
                                  CTCG
                                </div>
                                <div className="mt-1 w-10 h-0.5 bg-accent/20 mx-auto rounded-full" />
                              </div>
                            </div>

                            {/* FRONT */}
                            <div className="card-front bg-surface border-2 border-border-strong flex flex-col">
                              {/* Card image */}
                              <div className="flex-1 relative bg-surface-elevated overflow-hidden">
                                {card.image_url ? (
                                  <img
                                    src={card.image_url}
                                    alt={card.card_name}
                ...
                {phase === "summary" && (
                  <div className="max-w-2xl mx-auto">
                    <div className="rounded-xl border border-border-subtle bg-surface/80 p-6">
                      ...
                      <div className="divide-y divide-border-subtle/50">
                        {cards.map((card, i) => (
                          ...
                          >
                            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg overflow-hidden bg-surface-elevated flex-shrink-0">
                              {card.image_url ? (
                                <img
                                  src={card.image_url}
                                  alt={card.card_name}
                      ...
                      <div className="mt-4 pt-4 border-t border-border-subtle flex items-center justify-between">
                        ...
                        <span className="text-accent-strong font-bold text-lg">
                          {(() => {
                        ...
                        {points !== null &&
                          points >= selectedPack.cost_points && (
                            <button
                              ...
                              className="px-8 py-3 bg-accent hover:bg-accent-strong text-black font-bold rounded-xl transition text-lg"
                            >
                              Open Another
                            </button>
                          )}
                      ...
                      {drawId && (
                        <p className="mt-4 text-center text-xs">
                          <a
                            ...
                            className="text-secondary hover:text-emerald-300 underline"
                          >
