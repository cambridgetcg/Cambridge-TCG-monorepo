...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-page">
      ...
      <section className="border-b border-border-subtle">
        <div className="max-w-3xl mx-auto px-4 py-16 md:py-24 text-center">
          <h1 className="text-4xl md:text-5xl font-black text-ink leading-tight">
            More Than Cards.<br />
            <span className="text-accent-strong">A Community.</span>
          </h1>
          <p className="text-lg text-ink-muted mt-6 max-w-xl mx-auto leading-relaxed">
      ...
      <section className="border-b border-border-subtle">
        <div className="max-w-3xl mx-auto px-4 py-16">
          <h2 className="text-2xl font-bold text-ink mb-10">What We Stand For</h2>

          <div className="space-y-10">
            <div>
              <div className="flex items-center gap-3 mb-3">
                <span className="text-2xl">🎨</span>
                <h3 className="text-lg font-bold text-ink">Art and Nostalgia</h3>
              </div>
            ...
            <div>
              <div className="flex items-center gap-3 mb-3">
                <span className="text-2xl">🤝</span>
                <h3 className="text-lg font-bold text-ink">Community First</h3>
              </div>
              <p className="text-ink-muted leading-relaxed">
            ...
            <div>
              <div className="flex items-center gap-3 mb-3">
                <span className="text-2xl">💎</span>
                <h3 className="text-lg font-bold text-ink">The Collecting Journey</h3>
              </div>
              <p className="text-ink-muted leading-relaxed">
            ...
            <div>
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-lg font-bold text-ink">P2P with Trust</h3>
              </div>
              <p className="text-ink-muted leading-relaxed">
            ...
            <div>
              <div className="flex items-center gap-3 mb-3">
                <span className="text-2xl">📊</span>
                <h3 className="text-lg font-bold text-ink">A Financial Layer, Done Right</h3>
              </div>
              <p className="text-ink-muted leading-relaxed">
            ...
            <div>
              <div className="flex items-center gap-3 mb-3">
                <span className="text-2xl">🌱</span>
                <h3 className="text-lg font-bold text-ink">Giving Back</h3>
              </div>
              <p className="text-ink-muted leading-relaxed">
      ...
      <section className="border-b border-border-subtle">
        <div className="max-w-3xl mx-auto px-4 py-16">
          <h2 className="text-2xl font-bold text-ink mb-10">How It All Connects</h2>

          <div className="grid gap-4 sm:grid-cols-2">
            <div className="bg-surface rounded-xl p-5">
              <p className="text-accent-strong font-bold mb-1">Buy</p>
            ...
            <div className="bg-surface rounded-xl p-5">
              <p className="text-accent-strong font-bold mb-1">Collect</p>
              <p className="text-sm text-ink-muted">Track your portfolio. Watch values change. Complete sets. Earn achievements along the way.</p>
            </div>
            <div className="bg-surface rounded-xl p-5">
              <p className="text-accent-strong font-bold mb-1">Show</p>
              <p className="text-sm text-ink-muted">Pin your best cards to your public profile. Let the community see what you have built.</p>
            </div>
            <div className="bg-surface rounded-xl p-5">
              <p className="text-accent-strong font-bold mb-1">Trade</p>
            ...
            <div className="bg-surface rounded-xl p-5">
              <p className="text-accent-strong font-bold mb-1">Earn</p>
            ...
            <div className="bg-surface rounded-xl p-5">
              <p className="text-accent-strong font-bold mb-1">Connect</p>
      ...
      <section className="border-b border-border-subtle">
        <div className="max-w-3xl mx-auto px-4 py-16">
          <h2 className="text-2xl font-bold text-ink mb-6">Based in Cambridge</h2>
          <p className="text-ink-muted leading-relaxed">
      ...
      <section>
        <div className="max-w-3xl mx-auto px-4 py-16 text-center">
          <h2 className="text-2xl font-bold text-ink mb-4">Join the Community</h2>
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link
              href="/login"
              className="px-8 py-3 bg-accent text-black font-bold rounded-lg hover:bg-accent-strong transition"
            >
              Get Started
            </Link>
            <Link
              href="/catalog"
              className="px-8 py-3 bg-surface-elevated text-ink font-bold rounded-lg hover:bg-neutral-700 transition"
            >
              Browse Cards
            </Link>
            <Link
