  ...
  return (
    <div className="min-h-screen bg-page text-ink">
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-ink leading-tight max-w-4xl">
          {BRAND_HEADLINE}
        </h1>
            ...
            {THREE_OPERATIONS.map((op) => (
              ...
              >
                ...
                {op.url.startsWith("http") ? (
                  ...
                  <Link href={op.url} className="text-xs text-accent-strong hover:text-accent-strong">
                    {op.url} →
                  </Link>
                )}
              </div>
        ...
        <section className="mt-12">
          ...
          <p className="text-[11px] text-ink-faint mt-4">
            ...
            the audits at <Link href="/data" className="text-accent-strong hover:underline">/data</Link>{" "}
        ...
        <section className="mt-12">
          ...
          <div className="rounded-xl border border-border-subtle bg-surface/30 overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                {COVERAGE_FACTS.sources.shipped_list.map((s) => (
                  <tr key={s.id} className="border-b border-border-subtle/40">
        ...
        {/* Welcome statement */}
        <section className="mt-12 rounded-xl border border-border-subtle bg-surface/30 p-5">
          <p className="text-xs uppercase tracking-[0.2em] text-accent-strong mb-2">
          ...
          <p className="text-sm text-ink-muted leading-relaxed">
            ...
            <Link href="/welcome-all" className="text-accent-strong hover:text-accent-strong">
              the doors →
            </Link>
            {" · "}
            <Link href="/intro" className="text-accent-strong hover:text-accent-strong">
              new to TCG?
            </Link>
          </p>
        </section>
...
function CoverageCard({
  ...
  return (
    <div className="rounded-xl border border-border-subtle bg-surface/30 p-4">
      ...
      <p className="text-2xl font-mono text-accent-strong font-semibold">{value}</p>
...
function ConsumeCard({
  ...
  return (
    <Link
      href={href}
      className="block rounded-xl border border-border-subtle bg-surface/30 p-4 hover:bg-surface/60 hover:border-border-strong transition"
    >
      <p className="text-sm font-semibold text-ink mb-2">{title}</p>
      <p className="text-xs text-ink-muted leading-relaxed mb-3">{body}</p>
      <p className="text-[11px] font-mono text-accent-strong">{href} →</p>
    </Link>
  );
}
