  ...
  return (
    <main className="min-h-screen bg-page">
      <div className="max-w-3xl mx-auto px-4 py-12">
        <h1 className="text-2xl md:text-3xl font-bold text-ink mb-2">Terms of sale</h1>
        ...
        <div className="space-y-8 text-ink-muted text-sm leading-relaxed">
          <section>
            <h2 className="text-lg font-bold text-ink mb-3">Who you&apos;re buying from</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3">Orders</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3">Pricing</h2>
            <ul className="list-disc pl-5 space-y-2">
              <li>
              ...
              <li>
                ...
                <Link href="/methodology" className="text-accent-strong underline">
                  how we price
                </Link>
                .
              </li>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3">Returns and cancellations</h2>
            <ul className="list-disc pl-5 space-y-2">
              <li>
              ...
              <li>
                ...
                own terms:{" "}
                <Link href="/trade-in/terms" className="text-accent-strong underline">
                  trade-in terms
                </Link>
                .
              </li>
          ...
          <section>
            ...
            <p>
              ...
              <Link href="/methodology/fees" className="text-accent-strong underline">
                fees &amp; commission
              </Link>
              .
            </p>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3">Governing law</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3">Honest gaps</h2>
            <p>
