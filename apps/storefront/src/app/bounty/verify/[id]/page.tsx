  ...
  return (
    <main className="min-h-screen bg-page text-ink">
      <div className="mx-auto max-w-2xl px-4 py-10">
        <div className="mb-8">
          <Link href="/bounty" className="text-sm text-ink-faint hover:text-ink-muted">&larr; Bounty Board</Link>
        ...
        {proof && !loading && (
          <>
            {/* Summary */}
            <section className="bg-surface border border-border-subtle rounded-xl p-5 mb-5">
              ...
              <div className="grid grid-cols-2 gap-y-2 gap-x-4 text-sm">
                ...
                <div className="font-mono text-accent-strong">{proof.rolled_rarity ?? "—"}</div>
            ...
            <section className="bg-surface border border-border-subtle rounded-xl p-5 mb-5">
              ...
              <div className="mt-4 text-xs text-ink-faint">
                ...
                <div className="font-mono text-[11px] bg-surface-elevated/60 rounded px-3 py-2">
              ...
              {verification && (
                <div className="space-y-4 text-sm">
                  ...
                  {verification.commitmentOk && verification.rarityOk && (
                    <p className="text-secondary text-sm font-semibold pt-2 border-t border-border-subtle">
            ...
            <section className="bg-surface/40 border border-border-subtle/60 rounded-xl p-5 mb-5 text-xs text-ink-faint">
...
function Check({
  ...
  return (
    <div className={`border-l-2 pl-3 ${passed ? "border-emerald-500" : "border-danger"}`}>
      <p className={`text-sm font-semibold ${passed ? "text-secondary" : "text-red-400"}`}>
        {passed ? "✓" : "✗"} {label}
      </p>
      {children}
    </div>
