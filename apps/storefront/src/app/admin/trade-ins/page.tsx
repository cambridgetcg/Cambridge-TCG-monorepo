              ...
              >
                ...
                {!state.rejected && (
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                    <div>
                      <label className="text-[11px] text-neutral-500 block mb-1 flex items-center justify-between">
    ...
    >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-neutral-900 rounded-xl p-4">
            <p className="text-xs text-neutral-500 uppercase tracking-wide">Needs Quote</p>
            <p className="text-2xl font-bold text-amber-400 mt-1">{countsByStatus["submitted"] ?? 0}</p>
          </div>
          <div className="bg-neutral-900 rounded-xl p-4">
            <p className="text-xs text-neutral-500 uppercase tracking-wide">In Flight</p>
            <p className="text-2xl font-bold text-white mt-1">
              {(countsByStatus["accepted"] ?? 0) + (countsByStatus["received"] ?? 0) + (countsByStatus["grading"] ?? 0)}
            </p>
          </div>
          <div className="bg-neutral-900 rounded-xl p-4">
            <p className="text-xs text-neutral-500 uppercase tracking-wide">Ready to Pay</p>
            <p className={`text-2xl font-bold mt-1 ${(countsByStatus["approved"] ?? 0) > 0 ? "text-emerald-400" : "text-white"}`}>
              {countsByStatus["approved"] ?? 0}
            </p>
          </div>
          <div className="bg-neutral-900 rounded-xl p-4">
            <p className="text-xs text-neutral-500 uppercase tracking-wide">Payout Owed</p>
            <p className="text-2xl font-bold text-white mt-1">{formatPrice(totalPayoutOwed)}</p>
          </div>
        </div>
        ...
        <input
          ...
          className="w-full mb-5 px-3 py-2 bg-neutral-900 border border-neutral-800 rounded-lg text-sm text-white placeholder-neutral-600 focus:outline-none focus:ring-2 focus:ring-amber-500/50"
        />
