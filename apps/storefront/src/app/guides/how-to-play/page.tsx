...
function SectionHeading({
  ...
  return (
    <h2
      id={id}
      className="text-2xl md:text-3xl font-black text-ink mb-6 scroll-mt-24"
    >
      <span className="text-accent-strong mr-2">{number}</span>
      {children}
    </h2>
  );
}
...
function Card({ children, className = "" }: { children: React.ReactNode; className?: string }) {
  return (
    <div className={`bg-surface rounded-xl p-5 border border-border-subtle ${className}`}>
      {children}
    </div>
  );
}
...
function Step({ n, children }: { n: number; children: React.ReactNode }) {
  return (
    <div className="flex gap-4 items-start">
      <span className="shrink-0 w-8 h-8 rounded-full bg-accent/20 text-accent-strong flex items-center justify-center text-sm font-black">
        {n}
      </span>
    ...
    <main className="min-h-screen bg-page">
      ...
      <section className="border-b border-border-subtle">
        <div className="max-w-3xl mx-auto px-4 py-16 md:py-24">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-ink leading-tight">
            How to Play One Piece TCG
            <br />
            <span className="text-accent-strong">Complete Beginner&apos;s Guide</span>
          </h1>
          ...
          <nav
            ...
            className="mt-10 bg-surface rounded-xl p-6 border border-border-subtle"
          >
            ...
            <ol className="grid gap-2 sm:grid-cols-2 text-sm">
              {toc.map((item, i) => (
                <li key={item.id}>
                  <a
                    href={`#${item.id}`}
                    className="flex items-center gap-2 text-ink-muted hover:text-accent-strong transition"
                  >
      ...
      <section className="border-b border-border-subtle">
        <div className="max-w-3xl mx-auto px-4 py-16">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <Card>
              <p className="text-accent-strong font-black text-lg mb-1">1 Leader</p>
            ...
            <Card>
              <p className="text-accent-strong font-black text-lg mb-1">50-Card Deck</p>
              <p className="text-sm text-ink-muted">
            ...
            <Card>
              <p className="text-accent-strong font-black text-lg mb-1">10 DON!! Cards</p>
              <p className="text-sm text-ink-muted">
          ...
          <Card className="mt-6">
            ...
            <Link
              ...
              className="inline-block px-5 py-2 bg-accent text-black font-bold rounded-lg text-sm hover:bg-accent-strong transition"
            >
          ...
          <div className="space-y-4">
            ...
            <Card>
              <div className="flex items-start gap-4">
                <span className="shrink-0 w-10 h-10 rounded-lg bg-accent/20 flex items-center justify-center text-lg font-black text-accent-strong">
                  L
                </span>
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-3 text-xs">
                    <span className="px-2 py-0.5 rounded-full bg-surface-elevated text-ink-muted">Power</span>
                    <span className="px-2 py-0.5 rounded-full bg-surface-elevated text-ink-muted">Life Value</span>
                    <span className="px-2 py-0.5 rounded-full bg-surface-elevated text-ink-muted">Colour</span>
                    <span className="px-2 py-0.5 rounded-full bg-surface-elevated text-ink-muted">Keywords</span>
                  </div>
                </div>
              </div>
            </Card>
            ...
            <Card>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-3 text-xs">
                    <span className="px-2 py-0.5 rounded-full bg-surface-elevated text-ink-muted">Cost</span>
                    <span className="px-2 py-0.5 rounded-full bg-surface-elevated text-ink-muted">Power</span>
                    <span className="px-2 py-0.5 rounded-full bg-surface-elevated text-ink-muted">Counter</span>
                    <span className="px-2 py-0.5 rounded-full bg-surface-elevated text-ink-muted">Colour</span>
                    <span className="px-2 py-0.5 rounded-full bg-surface-elevated text-ink-muted">Keywords</span>
                  </div>
                </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-3 text-xs">
                    ...
                    <span className="px-2 py-0.5 rounded-full bg-surface-elevated text-ink-muted">Counter</span>
                    <span className="px-2 py-0.5 rounded-full bg-surface-elevated text-ink-muted">Colour</span>
                    <span className="px-2 py-0.5 rounded-full bg-surface-elevated text-ink-muted">Trigger</span>
                  </div>
                </div>
              </div>
            </Card>
            ...
            <Card>
              <div className="flex items-start gap-4">
                <span className="shrink-0 w-10 h-10 rounded-lg bg-emerald-500/20 flex items-center justify-center text-lg font-black text-secondary">
                  S
                </span>
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-3 text-xs">
                    <span className="px-2 py-0.5 rounded-full bg-surface-elevated text-ink-muted">Cost</span>
                    <span className="px-2 py-0.5 rounded-full bg-surface-elevated text-ink-muted">Colour</span>
                    <span className="px-2 py-0.5 rounded-full bg-surface-elevated text-ink-muted">Effect</span>
                  </div>
                </div>
              </div>
            </Card>
            ...
            <Card>
              <div className="flex items-start gap-4">
                <span className="shrink-0 w-10 h-10 rounded-lg bg-danger/20 flex items-center justify-center text-lg font-black text-red-400">
                  D
                </span>
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-3 text-xs">
                    <span className="px-2 py-0.5 rounded-full bg-surface-elevated text-ink-muted">Pay Costs</span>
                    <span className="px-2 py-0.5 rounded-full bg-surface-elevated text-ink-muted">+1000 Power</span>
                    <span className="px-2 py-0.5 rounded-full bg-surface-elevated text-ink-muted">10 Total</span>
                  </div>
                </div>
              </div>
            </Card>
          ...
          <div className="space-y-4">
            <Card>
              <div className="flex items-center gap-3 mb-2">
                <span className="shrink-0 w-7 h-7 rounded-full bg-accent/20 text-accent-strong flex items-center justify-center text-xs font-black">
                  1
                </span>
      ...
      <section className="border-b border-border-subtle">
        <div className="max-w-3xl mx-auto px-4 py-16">
          ...
          <Card className="mt-8">
            <p className="text-accent-strong font-bold mb-1">Remember</p>
            <p className="text-sm text-ink-muted">
      ...
      <section className="border-b border-border-subtle">
        <div className="max-w-3xl mx-auto px-4 py-16">
          ...
          <div className="space-y-5">
            ...
            <Step n={2}>
              <p>
                ...
                <span className="text-accent-strong">Leader</span> (always a valid
                target) or any of their{" "}
                <span className="text-accent-strong">rested Characters</span> (you
            ...
            <Step n={6}>
              ...
              <ul className="mt-2 space-y-2 text-sm">
                <li className="flex gap-2">
                  <span className="text-accent-strong font-bold shrink-0">vs Leader:</span>
                ...
                <li className="flex gap-2">
                  <span className="text-accent-strong font-bold shrink-0">vs Character:</span>
                  <span className="text-ink-muted">
          ...
          <Card className="mt-8">
            <p className="text-accent-strong font-bold mb-1">Key Concept</p>
            <p className="text-sm text-ink-muted">
      ...
      <section className="border-b border-border-subtle">
        <div className="max-w-3xl mx-auto px-4 py-16">
          ...
          <Card className="mt-6">
            <p className="text-accent-strong font-bold mb-2">
            ...
            <div className="grid grid-cols-5 gap-2 text-center text-sm">
              {[
                ...
                <div key={t.turn} className="bg-surface-elevated rounded-lg py-2">
                  <p className="text-ink-faint text-xs">{t.turn}</p>
                  <p className="text-accent-strong font-black text-lg">{t.don}</p>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <Card>
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="text-ink-muted font-bold">Black</h3>
              </div>
              <p className="text-sm text-ink-muted leading-relaxed">
      ...
      <section className="border-b border-border-subtle">
        <div className="max-w-3xl mx-auto px-4 py-16">
          ...
          <Card className="mb-6">
            <p className="text-accent-strong font-bold mb-3">Deck Construction Rules</p>
          ...
          <h3 className="text-ink font-bold text-lg mb-4">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link
              href="/deck-builder"
              className="px-5 py-2.5 bg-accent text-black font-bold rounded-lg text-sm hover:bg-accent-strong transition"
            >
              Open Deck Builder &rarr;
            </Link>
            <Link
              href="/catalog?game=one-piece"
              className="px-5 py-2.5 bg-surface-elevated text-ink font-bold rounded-lg text-sm hover:bg-neutral-700 transition"
            >
              Browse All Cards
            </Link>
          </div>
      ...
      <section>
        <div className="max-w-3xl mx-auto px-4 py-16 md:py-24 text-center">
          <h2
            id="ready-to-play"
            className="text-3xl md:text-4xl font-black text-ink mb-4 scroll-mt-24"
          >
            Ready to Play?
          </h2>
          ...
          <div className="grid gap-4 sm:grid-cols-2 max-w-xl mx-auto">
            <Link
              href="/deck-builder"
              className="block bg-surface rounded-xl p-5 border border-border-subtle hover:border-accent/50 transition group"
            >
              <p className="text-ink font-bold group-hover:text-accent-strong transition mb-1">
          ...
          <div className="mt-10">
            <Link
              href="/guides"
              className="text-sm text-ink-faint hover:text-accent-strong transition"
            >
