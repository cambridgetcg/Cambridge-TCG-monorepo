  ...
  return (
    <div className="prose max-w-3xl mx-auto py-12 px-4">
      ...
      <form onSubmit={handleSubmit} className="my-6 space-y-4">
        <label className="block">
          ...
          <input
            ...
            className="w-full bg-surface border border-border-subtle rounded px-3 py-2 font-mono text-sm"
          />
        ...
        <button
          ...
          className="bg-ink hover:bg-ink/85 disabled:bg-surface-subtle disabled:text-ink-faint text-page font-semibold px-5 py-2 rounded-lg transition-colors"
        >
      ...
      {error && (
        <div
          role="alert"
          className="my-4 border border-danger bg-danger/10 text-danger rounded p-4"
        >
            ...
            <div>
              ...
              <ul className="list-none p-0 space-y-2">
                {result.violations.map((v, i) => (
                  <li
                    key={i}
                    className="border border-border-subtle rounded p-3 bg-surface-subtle"
                  >
