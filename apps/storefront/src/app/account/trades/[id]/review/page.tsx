        ...
        {[1, 2, 3, 4, 5].map((i) => (
          <button
            ...
            className={`text-2xl transition ${
              i <= (hover || value) ? "text-accent-strong" : "text-neutral-700"
            } hover:scale-110`}
          >
            ★
          </button>
    ...
    return (
      <div className="max-w-lg mx-auto py-12 text-center">
        <div className="bg-surface rounded-xl p-8">
          ...
          <Link
            href="/account/trades"
            className="inline-block px-6 py-2.5 rounded-lg bg-accent text-black font-semibold text-sm hover:bg-accent-strong transition"
          >
            Back to Trades
          </Link>
        </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <textarea
            ...
            rows={4}
            className="w-full bg-surface text-ink rounded-lg px-3 py-2 text-sm border border-border-strong focus:border-accent focus:outline-none resize-none"
        ...
        <button
          ...
          className="w-full py-3 rounded-lg bg-accent text-black font-semibold text-sm hover:bg-accent-strong transition disabled:opacity-50"
        >
