...
export default function ReturnsPage() {
  ...
  return (
    <div>
      ...
      <h1 className="text-2xl font-black text-ink mb-2">Returns</h1>
    ...
    <div className="bg-surface rounded-xl p-4 border border-border-subtle">
      ...
      {row.refund_amount && (
        <div className="flex items-center gap-2 mb-2 text-xs">
          ...
          <span className={`font-mono font-bold ${row.status === "refunded" ? "text-secondary" : "text-ink"}`}>
          ...
          {RETURN_STEPS.map((step, i) => {
            ...
            return (
              <div key={step} className="flex items-center gap-2 flex-1 min-w-0">
                ...
                <span className={`text-[10px] capitalize whitespace-nowrap ${done ? "text-ink" : "text-neutral-600"}`}>
                  {step}
                </span>
        ...
        <div className="mt-3 pt-3 border-t border-border-subtle">
          ...
          <div className="grid grid-cols-2 gap-2 mb-2">
            <input
              ...
              className="px-2 py-1 bg-surface-elevated border border-border-strong rounded text-ink text-sm"
            />
            <input
              type="text"
              value={tracking}
              ...
              className="px-2 py-1 bg-surface-elevated border border-border-strong rounded text-ink text-sm font-mono"
            />
          </div>
