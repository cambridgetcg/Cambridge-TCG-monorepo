      ...
      <div className="grid gap-6 md:grid-cols-[280px_1fr]">
        <div className="space-y-3">
          {card.image_url ? (
            ...
            <div className="aspect-[5/7] rounded-lg border border-border-subtle bg-surface flex items-center justify-center text-neutral-600 text-xs">
              No image
            </div>
          )}
        </div>
          ...
          <Card>
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <span
                  className={
                    "font-mono " + (card.stock > 0 ? "text-secondary" : "text-neutral-600")
                  }
                >
                  {card.stock}
                </span>
