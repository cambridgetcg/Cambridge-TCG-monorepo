...
const STATUS_TONE: Record<string, string> = {
  paid: "bg-warning/15 text-warning ring-warning/30",
  allocated: "bg-info/15 text-info ring-info/30",
  shipped: "bg-ok/15 text-ok ring-ok/30",
  delivered: "bg-ok/20 text-ok ring-ok/40",
  cancelled: "bg-ink-faint/15 text-ink-muted ring-border-strong",
  refunded: "bg-[#6a5a8f]/15 text-[#6a5a8f] ring-[#6a5a8f]/30",
};
