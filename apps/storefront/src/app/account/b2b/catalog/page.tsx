    ...
    <div className="space-y-6">
      ...
      {!channelMatched && (
        <Card>
          <div className="text-sm text-accent-strong">
            ...
            (<code className="rounded bg-surface-elevated px-1 text-xs">WHOLESALE_B2B_API_KEY</code>),
      ...
      <Card>
        ...
        >
          ...
          <button
            type="submit"
            className="rounded bg-accent px-4 py-1.5 text-sm font-medium text-neutral-950 hover:bg-accent-strong"
          >
            Apply
          </button>
          {(game || set || q || inStock) && (
      ...
      <div className="overflow-x-auto rounded-lg border border-border-subtle">
        <table className="w-full text-left text-sm">
          <thead className="bg-surface-elevated text-xs uppercase tracking-wider text-ink-muted">
            <tr>
          ...
          <tbody className="divide-y divide-border-subtle">
            {pricesResp.items.map((card) => {
              ...
              return (
                <tr key={card.sku} className="bg-surface hover:bg-surface-elevated/60">
                  ...
                  <td className="px-3 py-3 text-right font-mono text-xs">
                    <span className={card.stock > 0 ? "text-secondary" : "text-neutral-600"}>
                      {card.stock}
                    </span>
          ...
          <div className="flex gap-2">
            {page > 1 && (
              <Link
                ...
                className="rounded border border-border-strong px-3 py-1 hover:border-accent hover:text-accent-strong"
              >
                ← Prev
              </Link>
            )}
