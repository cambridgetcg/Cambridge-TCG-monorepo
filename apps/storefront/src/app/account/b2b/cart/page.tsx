  ...
  return (
    <div className="space-y-6">
      ...
      {(hasOutOfStock || hasMissing) && (
        <Card>
          <div className="text-sm text-accent-strong space-y-1">
            {hasOutOfStock && (
              <p>
      ...
      <div className="overflow-x-auto rounded-lg border border-border-subtle">
        <table className="w-full text-left text-sm">
              ...
              return (
                <tr key={line.sku} className="bg-surface">
                  ...
                  <td className="px-3 py-3 text-right font-mono text-xs">
                    {card ? (
                      <span className={overSold ? "text-red-400" : card.stock > 0 ? "text-secondary" : "text-neutral-600"}>
                        {card.stock}
                      </span>
                    ) : (
          ...
          <tfoot className="bg-surface-elevated/50 border-t border-border-subtle">
            <tr>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex gap-3">
          ...
          <Link
            ...
            className={
              "rounded bg-accent px-5 py-2 text-sm font-semibold text-neutral-950 hover:bg-accent-strong " +
