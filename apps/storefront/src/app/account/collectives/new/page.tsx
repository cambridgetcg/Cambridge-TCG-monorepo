      ...
      <form action={handleSubmit} className="space-y-5">
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 rounded-lg bg-neutral-900 border border-neutral-800 text-white text-sm placeholder-neutral-600 focus:outline-none focus:border-amber-500"
          />
        </div>

        <div>
          <label className="block text-[11px] uppercase tracking-wider text-neutral-500 mb-1">
            URL slug — /c/<span className="text-neutral-300">{effectiveSlug || "your-slug"}</span>
          </label>
          <input
            name="slug_visible"
            required
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="px-4 py-2 rounded-lg text-sm font-bold bg-amber-500 text-black hover:bg-amber-400 disabled:opacity-40 disabled:cursor-not-allowed"
          >
