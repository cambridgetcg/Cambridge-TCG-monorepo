      ...
      <div className="max-w-xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl md:text-4xl font-black text-ink">
            Claim Your <span className="text-accent-strong">OG Status</span>
          </h1>
        ...
        {/* Letter */}
        <div className="bg-surface border border-border-subtle rounded-xl p-6 mb-8 text-sm text-ink-muted leading-relaxed">
          <p>If you&apos;ve ever purchased from Cambridge TCG — on eBay, Cardmarket, our Shopify store, in person, or anywhere else — you qualify for <strong className="text-accent-strong">permanent OG membership</strong>.</p>
        ...
        {/* What you get */}
        <div className="bg-gradient-to-r from-amber-500/10 to-yellow-500/10 border border-accent/20 rounded-xl p-5 mb-8">
          <h2 className="text-ink font-bold mb-3 flex items-center gap-2">
            <span>👑</span> OG Member Perks
          </h2>
          <div className="grid gap-2 sm:grid-cols-2 text-sm">
            <div className="flex items-center gap-2 text-ink-muted">
              <span className="text-secondary">&#10003;</span> 7% store discount
            </div>
            <div className="flex items-center gap-2 text-ink-muted">
              <span className="text-secondary">&#10003;</span> 7% cashback on cash
            </div>
            <div className="flex items-center gap-2 text-ink-muted">
              <span className="text-secondary">&#10003;</span> 7x Berries multiplier
            </div>
            <div className="flex items-center gap-2 text-ink-muted">
              <span className="text-secondary">&#10003;</span> 0% P2P commission
            </div>
            <div className="flex items-center gap-2 text-ink-muted">
              <span className="text-secondary">&#10003;</span> 0% auction fees
            </div>
            <div className="flex items-center gap-2 text-ink-muted">
              <span className="text-secondary">&#10003;</span> Priority everything
            </div>
          </div>
          <p className="text-xs text-accent-strong/70 mt-3">Free forever. Cannot be purchased. Exclusive to original customers.</p>
        </div>
