...
export const metadata: Metadata = {
  ...
  title: "Cambridge TCG — UK TCG marketplace, wholesale data, and open TCG data",
  description: "Cambridge TCG is a UK trading-card platform: a regulated peer-to-peer card marketplace, a B2B wholesale data operation, and a free open data layer covering 21 games. Prices with sources shown, fair fees, and an open API anyone can build on.",
  ...
  openGraph: {
    title: "Cambridge TCG — UK TCG marketplace, wholesale data, and open TCG data",
    description: "A regulated peer-to-peer card marketplace based in Cambridge, UK, a B2B wholesale data operation, and a free open data layer covering 21 trading-card games. Prices with sources shown, fair fees, and an open API anyone can build on.",
  ...
  twitter: {
    ...
    title: "Cambridge TCG — UK TCG marketplace, wholesale data, and open TCG data",
    description: "A UK P2P card marketplace, a wholesale data operation, and free open TCG data covering 21 games. Prices with sources shown, and an open API anyone can build on.",
    ...
    >
      <head>
        <Script id="org-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          description: "UK-based peer-to-peer trading card marketplace and open TCG data provider. Trade and collect One Piece, Pokémon, and Dragon Ball TCG cards.",
