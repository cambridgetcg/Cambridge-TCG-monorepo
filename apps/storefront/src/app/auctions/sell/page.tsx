  ...
  return (
    <div className="min-h-screen bg-page">
      <div className="max-w-2xl mx-auto px-4 py-8">
        {/* Hero */}
        <div className="mb-8">
          <h1 className="text-3xl font-black text-ink">Sell Your Cards at Auction</h1>
        ...
        {/* How it works */}
        <div className="bg-surface rounded-xl p-5 mb-8 border border-border-subtle">
          <h2 className="text-sm font-bold text-accent-strong uppercase tracking-wider mb-3">How It Works</h2>
          <div className="space-y-2 text-sm text-ink-muted">
            <div className="flex gap-3">
              <span className="shrink-0 w-6 h-6 rounded-full bg-accent/20 text-accent-strong text-xs flex items-center justify-center font-bold">1</span>
              <span>List your card with photos and a starting price</span>
            </div>
            <div className="flex gap-3">
              <span className="shrink-0 w-6 h-6 rounded-full bg-accent/20 text-accent-strong text-xs flex items-center justify-center font-bold">2</span>
              <span>We review and approve your listing</span>
            </div>
            <div className="flex gap-3">
              <span className="shrink-0 w-6 h-6 rounded-full bg-accent/20 text-accent-strong text-xs flex items-center justify-center font-bold">3</span>
              <span>Your auction goes live and buyers bid</span>
            </div>
            <div className="flex gap-3">
              <span className="shrink-0 w-6 h-6 rounded-full bg-accent/20 text-accent-strong text-xs flex items-center justify-center font-bold">4</span>
              <span>Winner pays, you ship to CTCG for verification</span>
            </div>
            <div className="flex gap-3">
              <span className="shrink-0 w-6 h-6 rounded-full bg-accent/20 text-accent-strong text-xs flex items-center justify-center font-bold">5</span>
            ...
            <div className="bg-surface rounded-xl p-4 border border-border-subtle">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="border-t border-border-subtle pt-2 flex justify-between">
                  ...
                  <span className="text-secondary font-bold">{formatPrice(payout)}</span>
                </div>
              </div>
            </div>
          )}
