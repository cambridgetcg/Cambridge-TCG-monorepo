    ...
    <main className="min-h-screen bg-page">
      ...
      <section className="border-b border-border-subtle">
        <div className="max-w-3xl mx-auto px-4 py-16 text-center">
          <h1 className="text-4xl md:text-5xl font-black text-ink">
            Membership <span className="text-accent-strong">Rewards</span>
          </h1>
      ...
      <section className="border-b border-border-subtle">
        <div className="max-w-3xl mx-auto px-4 py-16">
          <h2 className="text-2xl font-bold text-ink mb-10">How It All Works</h2>

          {/* Berries */}
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              <span className="w-10 h-10 bg-accent/20 rounded-full flex items-center justify-center text-lg">⭐</span>
              <h3 className="text-xl font-bold text-ink">Berries</h3>
            </div>
            <div className="space-y-3 text-ink-muted text-sm leading-relaxed pl-13">
              ...
              <p>Spend your Berries in the <Link href="/rewards" className="text-accent-strong hover:text-accent-strong underline decoration-dotted underline-offset-2">Rewards Hub</Link> — on <strong className="text-ink">virtual booster packs</strong>, <strong className="text-ink">premium daily spins</strong>, <strong className="text-accent-strong">raffles</strong> (enter for a chance to win high-value cards), and <strong className="text-purple-400">mystery boxes</strong> (guaranteed rewards — bonus Berries, store credit, or real cards).</p>
              <div className="bg-surface rounded-lg p-4 mt-3">
                ...
                <p className="text-ink font-medium">£100 × 10 Berries × 2.0x = <span className="text-accent-strong">2,000 Berries</span></p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-bold text-ink">Cashback</h3>
            </div>
            <div className="space-y-3 text-ink-muted text-sm leading-relaxed pl-13">
              ...
              <div className="bg-surface rounded-lg p-4 mt-3">
                ...
                <p className="text-ink font-medium">Cashback: £60 (cash) × 3% = <span className="text-secondary">£1.80 store credit</span></p>
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-bold text-ink">Store Discount</h3>
            </div>
            <div className="space-y-3 text-ink-muted text-sm leading-relaxed pl-13">
              <p><strong className="text-ink">Platinum members only.</strong> Get <strong className="text-purple-400">12% off every purchase</strong> in the store — applied automatically at checkout.</p>
              ...
              <div className="bg-surface rounded-lg p-4 mt-3">
                ...
                <p className="text-ink font-medium">Price: £100 - 12% = <span className="text-purple-400">£88.00</span></p>
                <p className="text-ink font-medium mt-1">Cashback: £88 × 8% = <span className="text-secondary">£7.04 store credit</span></p>
                <p className="text-ink font-medium mt-1">Berries: £88 × 10 × 3x = <span className="text-accent-strong">2,640 Berries</span></p>
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-bold text-ink">Store Credit</h3>
            </div>
            <div className="space-y-3 text-ink-muted text-sm leading-relaxed pl-13">
              ...
              <div className="bg-surface rounded-lg p-4 mt-3">
                ...
                <p className="text-ink font-medium mt-1">Cashback: £60 × 5% = <span className="text-secondary">£3.00 credit</span> (on cash only)</p>
                <p className="text-ink font-medium mt-1">Berries: £60 × 10 × 2x = <span className="text-accent-strong">1,200 Berries</span> (on cash only)</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              <span className="w-10 h-10 bg-accent/20 rounded-full flex items-center justify-center text-lg">📈</span>
              <h3 className="text-xl font-bold text-ink">Tier Progression</h3>
            </div>
            <div className="space-y-3 text-ink-muted text-sm leading-relaxed pl-13">
      ...
      <section className="border-b border-border-subtle">
        <div className="max-w-4xl mx-auto px-4 py-16">
          <h2 className="text-2xl font-bold text-ink mb-8 text-center">Compare Tiers</h2>
            ...
            <table className="w-full text-sm min-w-[600px]">
              ...
              <tbody className="text-ink-muted">
                ...
                <tr className="border-b border-border-subtle">
                  ...
                  <td className="text-center py-3 px-3 text-ink-faint">—</td>
                  <td className="text-center py-3 px-3 text-ink-faint">—</td>
                  <td className="text-center py-3 px-3 text-secondary font-bold">12% off</td>
                </tr>
                <tr className="border-b border-border-subtle">
                  ...
                  <td className="text-center py-3 px-3 text-secondary font-bold">8%</td>
                </tr>
                <tr className="border-b border-border-subtle">
                  ...
                  <td className="text-center py-3 px-3 text-accent-strong font-bold">3x</td>
                </tr>
                <tr className="border-b border-border-subtle">
                  ...
                  <td className="text-center py-3 px-3">5%</td>
                  <td className="text-center py-3 px-3 text-secondary font-bold">0%</td>
                </tr>
                <tr className="border-b border-border-subtle">
                ...
                <tr>
                  ...
                  <td className="text-center py-3 px-3 text-secondary font-bold">Yes</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <section className="border-b border-border-subtle">
        <div className="max-w-3xl mx-auto px-4 py-16">
          <h2 className="text-2xl font-bold text-ink mb-8">Important Details</h2>

          <div className="space-y-6 text-sm text-ink-muted leading-relaxed">
            <div className="bg-surface rounded-xl p-5">
              <h3 className="text-ink font-bold mb-2">What earns cashback and Berries?</h3>
              <p><strong className="text-secondary">Cash payments</strong> — Yes, cashback and Berries are earned.</p>
            ...
            <div className="bg-surface rounded-xl p-5">
              <h3 className="text-ink font-bold mb-2">What does the Platinum discount apply to?</h3>
            ...
            <div className="bg-surface rounded-xl p-5">
              <h3 className="text-ink font-bold mb-2">How is cashback paid?</h3>
            ...
            <div className="bg-surface rounded-xl p-5">
              <h3 className="text-ink font-bold mb-2">How are tiers calculated?</h3>
      ...
      <section>
        <div className="max-w-3xl mx-auto px-4 py-16 text-center">
          <h2 className="text-2xl font-bold text-ink mb-4">Start Earning</h2>
          <p className="text-ink-muted mb-8">
            Create a free account and start earning Berries on every purchase.
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
            <Link href="/login" className="px-8 py-3 bg-accent text-black font-bold rounded-lg hover:bg-accent-strong transition">
              Sign Up Free
            </Link>
            <Link href="/account/membership" className="px-8 py-3 bg-surface-elevated text-ink font-bold rounded-lg hover:bg-neutral-700 transition">
              View My Membership
            </Link>
          </div>
          ...
          <p className="text-sm text-ink-faint mt-8">
            ...
            <Link href="/rewards" className="text-accent-strong hover:text-accent-strong underline decoration-dotted underline-offset-2">
              Rewards Hub
            </Link>
            .
            <WhyLink
