    ...
    <main className="min-h-screen bg-page text-ink">
      ...
      <div className="mx-auto max-w-3xl px-4 py-10">
        ...
        <p className="mt-3 text-xs text-ink-faint">
          Public access is for current viewing; Cambridge TCG grants no
          downstream reuse licence for this person-facing record. The account
          owner can withdraw it by making their profile private.
        </p>
        ...
        <div className="mt-6 flex flex-wrap gap-3 text-sm">
          ...
          <Link href="/privacy" className="rounded-lg border border-border-subtle px-4 py-2">
