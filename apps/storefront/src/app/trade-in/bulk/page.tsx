        ...
        <div className="bg-surface border border-border-subtle rounded-lg p-5 mb-8">
          ...
          <div className="space-y-4 text-sm">
            <div className="flex items-start gap-3">
              <span className="shrink-0 w-14 text-right font-bold text-bid">2p</span>
            ...
            <div className="flex items-start gap-3">
              <span className="shrink-0 w-14 text-right font-bold text-accent">85%</span>
              <p className="text-ink-muted">
            ...
            <div className="flex items-start gap-3">
              <span className="shrink-0 w-14 text-right font-bold text-accent">Credit</span>
              <p className="text-ink-muted">
        ...
        <div className="bg-surface border border-border-subtle rounded-lg p-5 mb-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1 text-center pt-5">
              <p className="text-2xl font-bold text-bid">{formatPrice(baseTotal)}</p>
              <p className="text-xs text-ink-faint">base value (+ bonuses for gems)</p>
            </div>
          </div>
          {count > 0 && count < 50 && (
            <p className="text-xs text-warning mt-2">Minimum 50 cards for bulk trade-in.</p>
          )}
        </div>
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="text-ink-muted">
                <tr className="border-b border-border-subtle">
                  ...
                  <td className="text-right text-bid font-mono">£2.00</td>
                  <td className="text-right text-accent">£2.00 + gems bonus</td>
                </tr>
                <tr className="border-b border-border-subtle">
                  <td className="py-2">500 cards</td>
                  <td className="text-right text-bid font-mono">£10.00</td>
                  <td className="text-right text-accent">£10.00 + gems bonus</td>
                </tr>
                <tr className="border-b border-border-subtle">
                  <td className="py-2">1,000 cards</td>
                  <td className="text-right text-bid font-mono">£20.00</td>
                  <td className="text-right text-accent">£20.00 + gems bonus</td>
                </tr>
                <tr>
                  <td className="py-2">5,000 cards</td>
                  <td className="text-right text-bid font-mono">£100.00</td>
                  <td className="text-right text-accent">£100.00 + gems bonus</td>
                </tr>
              </tbody>
            </table>
          </div>
