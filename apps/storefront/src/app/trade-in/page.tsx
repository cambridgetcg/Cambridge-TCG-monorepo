  ...
  return (
    <main className="min-h-screen bg-page">
      ...
      <section className="border-b border-border-subtle">
        <div className="max-w-7xl mx-auto px-4 py-12 md:py-16">
          <h1 className="text-3xl md:text-5xl font-black text-ink">
            Sell Your <span className="text-accent-strong">Cards</span>
          </h1>
          ...
          <div className="grid grid-cols-2 gap-2 sm:grid-cols-5 sm:gap-4 mt-6">
            <div className="bg-surface rounded-xl px-5 py-3">
              <p className="text-2xl font-bold text-accent-strong">{cardsWanted}</p>
            ...
            <div className="bg-surface rounded-xl px-5 py-3">
              <p className="text-2xl font-bold text-secondary">Up to 85%</p>
              <p className="text-xs text-ink-muted">Market value in cash</p>
            </div>
            <div className="bg-surface rounded-xl px-5 py-3">
              <p className="text-2xl font-bold text-accent-strong">+20%</p>
              <p className="text-xs text-ink-muted">MINT bonus</p>
            </div>
            <div className="bg-surface rounded-xl px-5 py-3">
              <p className="text-2xl font-bold text-accent-strong">24h</p>
              <p className="text-xs text-ink-muted">Price lock</p>
            </div>
          </div>

          {/* Payout tiers */}
          <div className="mt-6 bg-surface border border-border-subtle rounded-xl p-5 max-w-2xl">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex items-start gap-3">
                <span className="shrink-0 w-16 text-right font-bold text-secondary">Cash</span>
              ...
              <div className="flex items-start gap-3">
                <span className="shrink-0 w-16 text-right font-bold text-accent-strong">MINT</span>
          ...
          <div className="flex gap-3 mt-6 text-sm">
            <Link
              href="/trade-in/terms"
              className="text-accent-strong hover:text-accent-strong underline underline-offset-2 transition"
            >
              Trade-in terms
            </Link>
      ...
      <section className="max-w-7xl mx-auto px-4 pt-8 grid gap-4 sm:grid-cols-3">
        <div className="bg-gradient-to-r from-amber-500/10 to-emerald-500/10 border border-accent/20 rounded-xl p-5 flex flex-col justify-between">
          <div>
          ...
          <Link
            ...
            className="mt-4 inline-block px-5 py-2.5 bg-accent text-black text-sm font-bold rounded-lg hover:bg-accent-strong transition text-center"
          >
            Request Quote
          </Link>
        </div>
        <div className="bg-gradient-to-r from-purple-500/10 to-blue-500/10 border border-purple-500/20 rounded-xl p-5 flex flex-col justify-between">
          ...
          <Link
            ...
            className="mt-4 inline-block px-5 py-2.5 bg-purple-500 text-ink text-sm font-bold rounded-lg hover:bg-purple-400 transition text-center"
          >
            Sell a Bundle
          </Link>
        </div>
