  ...
  return (
    <main className="min-h-screen bg-page">
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-invert max-w-none space-y-8 text-ink-muted text-sm leading-relaxed">
          <section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li><strong className="text-secondary">Base rate:</strong> <strong>2p per card</strong> for all Common (C), Uncommon (UC), and Rare (R) cards. No sorting required — just count and send.</li>
              <li><strong className="text-accent-strong">Valuable finds:</strong> If we identify cards in your bulk that are worth significantly more than 2p (tournament staples, alt art rares, valuable uncommons), we will pay <strong>85% of market value</strong> for those cards instead of the base rate. This amount is credited separately on top of your base payout.</li>
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:contact@cambridgetcg.com" className="text-accent-strong hover:underline">
