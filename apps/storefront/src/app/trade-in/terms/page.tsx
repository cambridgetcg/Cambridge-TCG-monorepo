  ...
  return (
    <main className="min-h-screen bg-page">
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-ink mb-8">Trade-In Terms &amp; Conditions</h1>

        <div className="prose max-w-none space-y-8 text-ink-muted text-sm leading-relaxed">
          <section>
            <h2 className="text-lg font-bold text-ink mb-3">Payout Rates</h2>
            <ul className="list-disc pl-5 space-y-2">
              <li><strong className="text-accent">Store Credit:</strong> Up to <strong>100% of market value</strong>. Store credit can only be used to purchase from Cambridge TCG.</li>
              <li><strong className="text-bid">Cash:</strong> Up to <strong>85% of market value</strong>, paid via bank transfer.</li>
              <li><strong className="text-accent">MINT Bonus (+20%):</strong> Cards in perfect MINT condition (pack-fresh, zero imperfections) may qualify for an additional <strong>20% bonus</strong> on top of the base payout. The MINT bonus is discretionary and subject to the evaluation and sole decision of Cambridge TCG. It is not guaranteed and may vary per card.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-lg font-bold text-ink mb-3">Bulk Card Trade-In</h2>
            <ul className="list-disc pl-5 space-y-2">
              <li><strong className="text-bid">Base rate:</strong> <strong>2p per card</strong> for all Common (C), Uncommon (UC), and Rare (R) cards. No sorting required — just count and send.</li>
              <li><strong className="text-accent">Valuable finds:</strong> If we identify cards in your bulk that are worth significantly more than 2p (tournament staples, alt art rares, valuable uncommons), we will pay <strong>85% of market value</strong> for those cards instead of the base rate. This amount is credited separately on top of your base payout.</li>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3">Card Condition</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3">Pricing &amp; Volatility</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3">Price Lock Guarantee</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3">Shipping</h2>
            <p>
            ...
            <div className="bg-surface rounded-lg p-4 mt-2 not-prose">
              <p className="text-ink text-sm">Cambridge TCG</p>
              <p className="text-ink text-sm">PO Box 1637</p>
              <p className="text-ink text-sm">CAMBRIDGE</p>
              <p className="text-ink text-sm">CB1 0PD</p>
            </div>
          </section>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3">Cancellation</h2>
            <p>
              ...
              <a href="mailto:contact@cambridgetcg.com" className="text-accent hover:underline">
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3">Age Requirement</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3">Record Keeping</h2>
            <p>
