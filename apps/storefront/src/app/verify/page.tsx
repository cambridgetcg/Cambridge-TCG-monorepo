    ...
    <main className="min-h-screen bg-page text-ink">
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <section className="bg-surface border border-border-subtle rounded-xl p-6 mb-6">
          ...
          <Link href="/verify/fairness" className="text-accent-strong hover:text-accent-strong underline text-sm">
        ...
        <section className="bg-surface border border-border-subtle rounded-xl p-6 mb-6">
          ...
          <Link href="/verify/chain" className="text-accent-strong hover:text-accent-strong underline text-sm">
            View the chain →
          </Link>
        </section>
        ...
        <section className="bg-surface border border-border-subtle rounded-xl p-6 mb-6">
          ...
          <Link href="/verify/how-it-works" className="text-accent-strong hover:text-accent-strong underline text-sm">
            Read the explainer →
          </Link>
        </section>
        ...
        <section className="bg-surface border border-border-subtle rounded-xl p-6">
          ...
          <Link href="/verify/health" className="text-accent-strong hover:text-accent-strong underline text-sm">
            View health →
          </Link>
        </section>
      </div>
