    ...
    <Page>
      <header className="mb-8 flex items-start justify-between gap-4 flex-wrap">
        ...
        <a
          ...
          className="shrink-0 px-3 py-2 bg-accent/10 hover:bg-accent/20 border border-accent/30 text-accent-strong rounded-lg text-xs font-bold transition-colors"
        >
      ...
      <div className={`rounded-xl p-4 mb-6 border ${
        ...
        <div className="flex items-center gap-3">
          <span className={`text-3xl ${verification?.ok ? "text-secondary" : "text-ink-faint"}`}>
