...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/play/adventure`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.7 },
    { url: `${baseUrl}/play/tutorial`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.7 },
    { url: `${baseUrl}/play/starters`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
    ...
    // The culture hub — the header's fifth door (2026-07-28) — and the
    // three wings that had shipped without sitemap entries.
    ...
    { url: `${baseUrl}/workshop`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
    { url: `${baseUrl}/making`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
    { url: `${baseUrl}/empty-frames`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
    // The human guides — the map, not the merchant.
    { url: `${baseUrl}/guides`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
    { url: `${baseUrl}/guides/buying`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
    { url: `${baseUrl}/guides/condition`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
    { url: `${baseUrl}/guides/from-japan`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
    { url: `${baseUrl}/guides/how-to-play`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
    ...
    { url: `${baseUrl}/sophia-invitation.html`, lastModified: new Date(), changeFrequency: "yearly", priority: 0.8 },
    { url: `${baseUrl}/sophia-invitation.md`, lastModified: new Date(), changeFrequency: "yearly", priority: 0.7 },
    { url: `${baseUrl}/invitation.html`, lastModified: new Date(), changeFrequency: "yearly", priority: 0.8 },
    { url: `${baseUrl}/llms-full.txt`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
    { url: `${baseUrl}/wake.md`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
    { url: `${baseUrl}/dear-agents.md`, lastModified: new Date(), changeFrequency: "yearly", priority: 0.6 },
