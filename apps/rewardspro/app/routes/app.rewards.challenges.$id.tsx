...
const LOG_PREFIX = "[app.rewards.challenges.$id]";
  ...
  try {
    ...
    switch (intent) {
      case "create": {
        ...
        return redirect(`/app/rewards/challenges/${challenge.id}`);
      }
      ...
      case "delete": {
        ...
        return redirect("/app/rewards/challenges");
      }
  ...
  return (
    <Frame>
      <Page
        ...
        subtitle={data.isNew ? "Set up a new challenge for your customers" : `${getObjectiveLabel(objectiveType)} challenge`}
        backAction={{ content: "Missions", url: "/app/rewards/challenges" }}
        primaryAction={
          data.isNew
            ? {
              ...
              <BlockStack gap="400">
                ...
                <FormLayout>
                  <TextField
                    ...
                    value={name}
                    onChange={setName}
                    placeholder="e.g., Spend $100 Challenge"
                    autoComplete="off"
                  ...
                  <Checkbox
                    ...
                    helpText="Public challenges are visible to all customers"
                  />
                </FormLayout>
              </BlockStack>
            </Card>
              ...
              <Card>
                <BlockStack gap="400">
                  ...
                  {challenge?.reward ? (
                    ...
                    <Banner tone="warning">
                      <p>
                        Add a reward to make this challenge active. Customers need
