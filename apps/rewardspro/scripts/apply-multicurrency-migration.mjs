...
/**
 * Migration Script for Multi-Currency Order Fields
 * Adds presentmentCurrency, presentmentTotal, exchangeRate to Order table
 */
...
async function applyMulticurrencyMigration() {
  ...
  console.log("🚀 Applying Multi-Currency Migration to Aurora Database\n");
  ...
  const statements = [
    {
      name: "Add presentmentCurrency column",
      sql: `ALTER TABLE "Order" ADD COLUMN IF NOT EXISTS "presentmentCurrency" TEXT;`
    },
    {
      name: "Add presentmentTotal column",
      sql: `ALTER TABLE "Order" ADD COLUMN IF NOT EXISTS "presentmentTotal" DECIMAL(10, 2);`
    },
    {
      name: "Add exchangeRate column",
      sql: `ALTER TABLE "Order" ADD COLUMN IF NOT EXISTS "exchangeRate" DECIMAL(10, 6);`
    }
  ];
  ...
  try {
    ...
    const migrationName = "20251219_add_multicurrency_fields";
    ...
    console.log("\n🎉 Multi-currency migration completed!");
