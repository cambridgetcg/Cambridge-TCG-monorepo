...
/**
 * Migration Script for Tier missing fields
 * Adds description, benefits, isActive columns to Tier table
 *
 * Date: 2024-12-23
 */
...
async function applyTierFieldsMigration() {
  ...
  console.log("🚀 Applying Tier Fields Migration to Aurora Database\n");
  ...
  const statements = [
    {
      name: "Add description column to Tier",
      sql: `ALTER TABLE "Tier" ADD COLUMN IF NOT EXISTS "description" TEXT;`
    },
    {
      name: "Add benefits column to Tier",
      sql: `ALTER TABLE "Tier" ADD COLUMN IF NOT EXISTS "benefits" JSONB;`
    },
    {
      name: "Add isActive column to Tier",
      sql: `ALTER TABLE "Tier" ADD COLUMN IF NOT EXISTS "isActive" BOOLEAN NOT NULL DEFAULT true;`
    }
  ];
  ...
  try {
    ...
    const migrationName = "20251223_add_tier_fields";
    ...
    console.log("\n🎉 Tier fields migration completed!");
