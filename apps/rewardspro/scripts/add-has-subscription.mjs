...
async function addHasSubscriptionColumn() {
  ...
  console.log("🚀 Adding hasSubscription column to TierProduct table\n");
  ...
  try {
    // Step 1: Add hasSubscription column
    console.log("Step 1: Adding hasSubscription column...");
    await client.send(new ExecuteStatementCommand({
      resourceArn,
      secretArn,
      database,
      sql: `ALTER TABLE "TierProduct"
            ADD COLUMN IF NOT EXISTS "hasSubscription" BOOLEAN NOT NULL DEFAULT false`,
      transactionId,
    }));
    ...
    const migrationName = "20251003_add_has_subscription";
    ...
    await client.send(new ExecuteStatementCommand({
      ...
      parameters: [
        ...
        { name: "checksum", value: { stringValue: "add_has_subscription_v1" }},
    ...
    console.log("Summary:");
    console.log("  - Added hasSubscription column to TierProduct table (default: false)");
