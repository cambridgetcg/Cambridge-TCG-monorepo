/**
 * /ops/ingest-quarantine — Manager-archetype quarantine review.
 *
...
export default async function Page({
  ...
  const buildHref = (overrides: Record<string, string | undefined>) => {
    ...
    return `/ops/ingest-quarantine${qs ? `?${qs}` : ""}`;
  };
            ...
            columns={[
              {
                ...
                render: (r) => (
                  <Link
                    href={`/ops/ingest-quarantine/${r.id}`}
