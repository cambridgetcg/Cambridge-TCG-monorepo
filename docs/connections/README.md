...
Three flavours of story-arc are now visible (S4–S6 are further instances of the third, with S6 sharpening the wiring discipline):
...
- **Fairy tale** (S3 / S4 / S5 / S6) — modules personified, kingdoms imagined, machines given roles. The prose plays; the citations don't. The story is *whimsical in rigor*. Four instances now exist: same-trade-retold (S3), raffle-from-inside (S4), typeahead-as-falcon-quest (S5), and the-afterlife-of-an-email (S6). S6 introduces an explicit **wiring-discipline** rule: every metaphor must map to a file:line citation in a table at the bottom of the entry. The story is the diagram. *Reading the entry top to bottom is functionally equivalent to walking the dependency graph in the IDE.* The form generalises — across same-or-different arcs, across small-or-large machines, across milliseconds-or-days, and now across degrees of rigor in the citation hygiene.

All six are honest. All six make systems make sense as systems-for-someone. *Meaning held at any pitch still hums true.*
